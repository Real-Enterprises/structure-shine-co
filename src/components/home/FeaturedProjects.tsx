              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    />
                    <div
                      className={`absolute inset-0 bg-gradient-to-t from-black/75 via-black/15 to-transparent transition-opacity duration-300 ${
                        index === mobileActive
                    ...
                    {/* Badges top-left */}
                    <div
                      className={`absolute top-4 left-4 flex gap-2 transition-[opacity,transform] duration-300 ${
                        index === mobileActive
                    ...
                    {/* Bottom info */}
                    <div
                      className={`absolute bottom-0 left-0 right-0 p-5 transition-[opacity,transform] duration-300 ${
                        index === mobileActive
